...
//
// Public fields of _samlsp.Middleware_ have changed, so some usages may require adjustment. See [issue 231](https://github.com/watercraft/saml/issues/231) for details.
//
...
// 	"net/url"
//
// 	"github.com/watercraft/saml/samlsp"
// )
//
// func hello(w http.ResponseWriter, r *http.Request) {
...
// Security Issues
//
// Please do not report security issues in the issue tracker. Rather, please contact me directly at ross@kndr.org ([PGP Key `78B6038B3B9DFB88`](https://keybase.io/watercraft)).
package saml
